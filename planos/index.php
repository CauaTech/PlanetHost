...
<!--HEAD COMPLETO-->
<head>
	<title>Planos de Hospedagem - PlanetHost</title>
	<meta name="language" content="pt-BR">
	<meta name="description" content="Escolha o plano de hospedagem de servidores de jogos que melhor atenda às suas necessidades e aproveite a melhor experiência de jogo na PlanetHost. Oferecemos uma variedade de planos flexíveis e personalizados para garantir que você obtenha o máximo de desempenho e recursos.">
...
<div class="produtos-planet">
	<div class="container">
	    ...
	    <div class="pprodutos">
	    	<div class="row">
	    		<div class="col-md-3">
	    			<div class="card pcard-planet">
	    				<div class="card-header pheader-card">
	    					<center>
	    						<img width="30%" src="<?php echo $flow;?>assents/img/1.png">
	    					</center>
	    				</div>
	    				<div class="card-body pcard-body">
	    					<center>
	    						...
	    						<div class="pcard-info">
	    							<div class="pitem-card">
	    								<i style="color: #1df259;" class="fi fi-br-check"></i> 3GB de Ram
	    							</div>
	    							<div class="pitem-card">
	    								<i style="color: #1df259;" class="fi fi-br-check"></i> 4GB Disco
	    							</div>
	    							<div class="pitem-card">
	    								<i style="color: #1df259;" class="fi fi-br-check"></i> Jogadores ilimitados
	    							</div>
	    							<div class="pitem-card">
	    								<i style="color: #1df259;" class="fi fi-br-check"></i> Permite Plugins & Mods
	    							</div>
	    							<div class="pitem-card">
	    								<i style="color: #1df259;" class="fi fi-br-check"></i> Java ou Bedrock Edition
	    							</div>
	    						</div>
	    						<div class="ppreco">
	    							R$ 12.00/Mensal
	    						...
	    						<div class="pcard-button">
	    							<button type="button" class="btn btn-produtos">Comece Agora!</button>
	    						</div>
	    					</center>
	    				</div>
	    			</div>
	    		...
	    		<div class="col-md-3">
	    			<div class="card pcard-planet">
	    				<div class="card-header pheader-card">
	    					<center>
	    						<img width="30%" src="<?php echo $flow;?>assents/img/2.png">
	    					</center>
	    				</div>
	    				<div class="card-body pcard-body">
	    					<center>
	    						...
	    						<div class="pcard-info">
	    							<div class="pitem-card">
	    								<i style="color: #1df259;" class="fi fi-br-check"></i> 4GB de Ram
	    							</div>
	    							<div class="pitem-card">
	    								<i style="color: #1df259;" class="fi fi-br-check"></i> 4GB Disco
	    							</div>
	    		...
	    		<div class="col-md-3">
	    			<div class="card pcard-planet">
	    				<div class="card-header pheader-card">
	    					<center>
	    						<img width="30%" src="<?php echo $flow;?>assents/img/3.png">
	    					</center>
	    				</div>
	    				<div class="card-body pcard-body">
	    					<center>
	    						...
	    						<div class="pcard-info">
	    							<div class="pitem-card">
	    								<i style="color: #1df259;" class="fi fi-br-check"></i> 8GB de Ram
	    							</div>
	    							<div class="pitem-card">
	    								<i style="color: #1df259;" class="fi fi-br-check"></i> 4GB Disco
	    							</div>
	    		...
	    		<div class="col-md-3">
	    			<div class="card pcard-planet">
	    				<div class="card-header pheader-card">
	    					<center>
	    						<img width="30%" src="<?php echo $flow;?>assents/img/4.png">
	    					</center>
	    				</div>
	    				<div class="card-body pcard-body">
	    					<center>
	    						...
	    						<div class="pcard-info">
	    							<div class="pitem-card">
	    								<i style="color: #1df259;" class="fi fi-br-check"></i> 12GB de Ram
	    							</div>
	    							<div class="pitem-card">
	    								<i style="color: #1df259;" class="fi fi-br-check"></i> 4GB Disco
	    							</div>
